...
[![AWS](https://img.shields.io/badge/AWS-Step%20Functions-FF9900?style=flat&logo=amazon-aws)](https://aws.amazon.com/step-functions/)
[![Python](https://img.shields.io/badge/Python-3.11-blue?style=flat&logo=python)](https://www.python.org/)
[![License](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)
[![GitHub](https://img.shields.io/badge/GitHub-LucianoHMG-black?style=flat&logo=github)](https://github.com/LucianoHMG)
...
│   ├── process-data/
│   │   └── app.py                        # Valida/enriquece dados
│   ├── finalize/
│   │   └── app.py                        # Consolida resultados
│   └── handle-error/
│       └── app.py                        # Tratamento de erros
│
└── events/                               # Eventos de Teste
    └── input.json                        # Payload de exemplo
```
...
```bash
git clone https://github.com/LucianoHMG/aws-stepfunctions-serverless-orchestration-demo.git
...
*Nota: Inclui free tier. Consulte [AWS Pricing](https://aws.amazon.com/pricing/) para detalhes.*
...
✅ **VPC (Opcional)**: Configure em `template.yaml`  
...
- [State Machine Example](https://docs.aws.amazon.com/step-functions/latest/dg/concepts-basic-concepts.html)
...
- LinkedIn: [Luciano Gião](https://linkedin.com/in/luciano-gião)
